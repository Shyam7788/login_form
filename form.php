...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/stayle.css">
			...
			<div class="col">
				...
				<div class="row boxcolor p-1 mt-1">
					...
					<div class="col-3 visa offset-1" >
						...
						<label for="visa" class="font1 card-size">VISA</label>
					</div>
					<div class="col-3 visa" >
						<input type="radio" name="cardtype">
						<label for="amex" class="font1 card-size">Amex</label>
					</div>
					<div class="col-4 visa" >
						<input type="radio" name="cardtype">
						<label for="mastercard" class="font1 card-size">Mastercard</label>
					</div>
				</div>
				<div class="row boxcolor p-1 mt-1">
					<div class="col-4">
